...
It also looks at the rise and wide spread use of Logistic Regression across varied subjects especially in healthcare and briefly explores the reasons and limitations of Logistic Regression.

Programs/Websites Used: R and Github

File Types Used: R(Quarto)/Github (HTML output files from R)

Installation Instructions: (1) Copy the file index.html to your computer and open it in a web browser. 

Running the Program: (1) open R studio or Rstudio server and download the program LR_ProjectFall2025SW.qmd. 
